...
THUMBNAIL_SIZE = 90
PAGE_SIZE = 20
PRODUCT_INFORMATION_FORM_ADDED_FIELDS = [
...
#ALLOWED_HOSTS = ['*']
ALLOWED_HOSTS = ['.cart.ulstercorpsdev.org',
                 'localhost',
                 '127.0.0.1',]
...
EMAIL_PORT = int(get_secret('CART_ULSTER_EMAIL_PORT'))
EMAIL_HOST_USER = get_secret('CART_ULSTER_EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = get_secret('CART_ULSTER_EMAIL_HOST_PASSWORD')
EMAIL_USE_TLS = eval(get_secret('CART_ULSTER_EMAIL_USE_TLS'))
EMAIL_USE_SSL = eval(get_secret('CART_ULSTER_EMAIL_USE_SSL'))
SERVER_EMAIL = get_secret('CART_ULSTER_EMAIL_FROM_USER')
...
MEDIA_ROOT = '/var/www/html/cart/cart_ulster/uploads'
